...
const Mint = () => {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      await mint(contract, account, Token, dispatch, price)
      ...
      setLoading(false)
      window.alert('Error creating the NFT')
      // console.log('Error creating the NFT: ', error)
    }
  }
  ...
  const renderForm = () => {
    return (
      <section>
        <h2>Mint an NFT</h2>
        <form id='form-minter' onSubmit={handleSubmit} onChange={handleChange}>
            ...
            {attributes.map((data, idx) => {
              ...
              return (
                <div key={idx} className='field'>
                  ...
                  <div className='field half'>
                    <input id={_kid} name={_kid} type='text' data-id={idx} placeholder='Key' className='trait_type' />
                  </div>
                  <div className='field half'>
                    <input id={_vid} name={_vid} type='text' data-id={idx} placeholder='Value' className='value' />
                  </div>
                </div>
              )
            })}
